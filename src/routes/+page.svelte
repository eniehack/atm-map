	...
	>
		...
		<GeoJSONSource data={filteredConvenienceData as any}>
			...
			<CircleLayer
				paint={{
					'circle-color':
						nearPoint !== null && typeof nearPoint !== 'undefined'
							? [
									'case',
...
<div class="absolute top-[13rem] right-2.5 bg-white rounded size-[29px]"
	...
	<span class="grid place-items-center p-1 text-red-200">
		{#if isDarkMode}
			<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="#2D7BBE" class="bi bi-moon-fill" viewBox="0 0 16 16">
			  <path d="M6 .278a.77.77 0 0 1 .08.858 7.2 7.2 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277q.792-.001 1.533-.16a.79.79 0 0 1 .81.316.73.73 0 0 1-.031.893A8.35 8.35 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.75.75 0 0 1 6 .278"/>
			</svg>
		{:else}
			<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="#ffc300" class="bi bi-sun-fill" viewBox="0 0 16 16">
